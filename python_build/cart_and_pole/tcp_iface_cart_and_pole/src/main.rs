///
/// Auto-generated TCP server for optimizer: cart_and_pole
///
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != CART_AND_POLE_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != CART_AND_POLE_NUM_PARAMETERS {
...
fn main() {
    let matches = App::new("OpEn TCP Server [cart_and_pole]")
        .version("0.0.0")
        .author("John Smith")
