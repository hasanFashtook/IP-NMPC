///
/// Auto-generated TCP server for optimizer: ball_and_plate
///
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != BALL_AND_PLATE_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != BALL_AND_PLATE_NUM_PARAMETERS {
...
fn main() {
    let matches = App::new("OpEn TCP Server [ball_and_plate]")
        .version("0.0.0")
        .author("John Smith")
